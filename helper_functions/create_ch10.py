"""
Generates Chapter_10.ipynb — Observational Studies (Structural Engineering version)
Grounded in Hibbeler Structural Analysis 8th ed., Chapter 1 (Loads) and Chapter 6 (Influence Lines)
"""
import json, os
...
def build_notebook():
    ...
    out = os.path.join(os.path.dirname(__file__), '..', 'Chapter_10.ipynb')
