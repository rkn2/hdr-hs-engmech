"""
Generates Chapter_9.ipynb — Samples (Structural Engineering version)
Grounded in Hibbeler Structural Analysis 8th ed., Chapter 1 (Types of Structures and Loads)
Run from the engineering_mechanics/ directory: python helper_functions/create_ch9.py
"""
...
def build_notebook():
    ...
    out_path = os.path.join(os.path.dirname(__file__), '..', 'Chapter_9.ipynb')
