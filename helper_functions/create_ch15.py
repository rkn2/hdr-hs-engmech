"""
Generates Chapter_15.ipynb — Probability Models (Structural Engineering version)
Grounded in Hibbeler + LRFD philosophy (load/resistance distributions, reliability index beta)
"""
import json, os
...
def build_notebook():
    ...
    out = os.path.join(os.path.dirname(__file__), '..', 'Chapter_15.ipynb')
